...
<td class="bg6" height="50" valign="middle" style="width:20%; text-align:center;border: 3px solid <?php echo $CorBordPlugin; ?>;border-radius: 9px;"><font size="4"> Ticket Nº &nbsp;<b></font><font size="5" color=#FF0000><?php echo $OsId;?></b></font><br><font size="1"><?php echo $DataOs;?></font></td></tr>
</table></td>
...
<tr><td width="50%"><b>Nom: </b><?php echo ($UserName) ?></td><td ><b>Téléphone Mobile: </b><?php echo ($UserTelefone)?></td></tr>
<tr><td width="50%"><b>Commentaire: </b><?php //echo ($UserEndereco)?></td><td><b>E-Mail: </b><?php echo ($UserEmail)?></td></tr>
<tr><td width="50%"><b>Téléphone Sté: </b><?php echo ($UserCepa)?></td><td ><b>Téléphone Utilisateur: </b><?php echo ($UserCep)?></td></tr>
...
<tr><td width="50%"><b>Titre:</b> <?php echo $OsNome;?></td><td width="50%"><b>Technicien:</b> <?php echo $OsResponsavel;?></td></tr>
...
<tr align="center"><td style="text-align:center;" ><b><?php echo ($UserName);?></b></td><td style="text-align:center;" ><b><?php echo ($EmpresaPlugin);?></b></td></tr>
</table>
</table>
<style media="print" type="text/css">
	body {print-color-adjust: exact;}
	.bg6 {background-color:#666666 !important}
	.botao, #botoes { display: none; }
	table > tr > td {text-align: left; padding: 5px;}
	table > tr {background-color:#666666 !important}
